...
Таблицы при этом должны быть созданы но очищены (пока вручную). Список таблиц см. ниже.
...
## Алиса ##
Для правильного распознавания остановок и команд необходимо заполнить таблицу Вариант названия автобусной остановки. Для быстрого заполнения можно воспользоваться командой Django add_options_name_for_bus_stop. В ней уже внесен список который копируется в БД. Путь к файлу для исправления списка: /schedule/management/commands/add_options_name_for_bus_stop.py.
