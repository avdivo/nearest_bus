...
class AnalizerTest(TestCase):
    ...
    def test_single_stop(self):
        ...
        test_cases = [
            ...
            # ("вокзал льнозавод", ["Автовокзал", "Льнозавод"]),
            ...
            # ("дом культуры до поликлиники", ["Дом культуры", "Поликлиника"]),
            # ("как доехать дома культуры 11 до поликлиники", ["Дом культуры", "Поликлиника"]),
            # ("как доехать из одинадцатого до вокзала", ["Социалистическая", "Автовокзал"]),
            # ("как доехать в одинадцатый с вокзала", ["Автовокзал", "Социалистическая"]),
            ...
            # ("одинадцатый городок", ["Социалистическая"]),
